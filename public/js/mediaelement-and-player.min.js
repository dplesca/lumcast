...
!function(e){e.extend(mejs.MepDefaults,{fasterslowerText:"Faster/Slower"}),e.extend(MediaElementPlayer.prototype,{buildfasterslower:function(a,t,n,p){var s=e('<div class="display-playback-speed hidden"><span>1x</span></div> ').appendTo(t).click(function(a){return a.preventDefault(),p.pause(),p.playbackRate=p.playbackRate<1.4?p.playbackRate+.1:1,e(".display-playback-speed span").text(Math.round(10*p.playbackRate)/10+"x"),p.play(),!1})
p.addEventListener("play",function(){"native"===p.pluginType&&s.hasClass("hidden")&&s.removeClass("hidden")},!1)}})}(mejs.$)

!function(e){e.extend(mejs.MepDefaults,{mp3titleText:"mp3 file title"}),e.extend(MediaElementPlayer.prototype,{buildmp3title:function(t,i,l,n){var a=e('<div class="display-playback-title"></div> ').appendTo(i);n.addEventListener("play",function(){"native"===n.pluginType&&a.removeClass("hidden")},!1)}})}(mejs.$);
